...
import { createCustomer, getCustomerByUsername, infoToken } from "../../service/Account";
...
export function Customer() {
    ...
    return (
        <>
        <Header/>
            <h1 className="text-center mt-5 pt-5">Thông tin cá nhân</h1>
            <Formik
                initialValues={{
                    id: customer?.id,
